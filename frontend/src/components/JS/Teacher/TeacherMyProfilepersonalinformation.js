...
const TeacherMyProfilepersonalinformation = () => {
  ...
  //     try {
  //       const response = await axios.get("http://localhost:5050/api/teacher/profile", {
  //         headers: {
  ...
  const handleSave = async () => {
    // try {
    //   await axios.put(
    //     "http://localhost:5050/api/teacher/edit-profile", // Adjusted the URL here
    //     {
    //       name: profile.name,
    //       email: profile.email,
    ...
    <div className={styles.dashboard}>
      <aside className={styles.sidebar}>
        ...
        <nav>
          ...
          <a
            href="/teacher/myprofile/address"
            className={
              location.pathname === "/teacher/myprofile/address"
                ? `${styles.navLink} ${styles.activeNavLink}`
                : styles.navLink
            }
          >
          ...
          <a
            href="/teacher/myprofile/bankaccountinformation"
            className={
              location.pathname === "/teacher/myprofile/bankaccountinformation"
                ? `${styles.navLink} ${styles.activeNavLink}`
                : styles.navLink
            }
          >
